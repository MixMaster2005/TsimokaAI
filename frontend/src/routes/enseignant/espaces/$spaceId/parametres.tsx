...
export const Route = createFileRoute('/enseignant/espaces/$spaceId/parametres')({
  ...
  component: ParametresEspaceEnseignant,
});

function ParametresEspaceEnseignant() {
  const { spaceId } = useParams({ from: '/enseignant/espaces/$spaceId/parametres' });
    ...
    <div className="max-w-lg p-6">
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <p className="text-xs text-encre-muted">Modifier le tag recalibre le registre disciplinaire</p>
        </div>
        <div className="flex flex-col gap-1.5">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Button variant="ghost" size="sm" asChild>
              <Link to="/enseignant/espaces/$spaceId/chat" params={{ spaceId }}>
                Tester dans le chat
              </Link>
            </Button>
          </div>
