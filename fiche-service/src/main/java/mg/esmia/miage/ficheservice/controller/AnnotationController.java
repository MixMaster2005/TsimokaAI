...
public class AnnotationController {
    ...
    public ApiResponse<AnnotationResponse> add(@PathVariable UUID ficheId, @Valid @RequestBody CreateAnnotationRequest request) {
    ...
    @GetMapping
    public ApiResponse<List<AnnotationResponse>> list(@PathVariable UUID ficheId) {
        UserContext ctx = authenticated();
